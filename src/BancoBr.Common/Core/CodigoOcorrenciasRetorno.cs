...
namespace BancoBr.Common.Core
{
    ...
    {
        public static Dictionary<string, string> Ocorrencias => new Dictionary<string, string>
        {
            ...
            { "BH", "Correntista não pagou salário" },
            { "BI", "Falecimento do mutuário" },
            { "BJ", "Correntista não enviou remessa do mutuário" },
            { "BK", "Correntista não enviou remessa no vencimento" },
            ...
            { "HA", "Lote Não Aceito" },
            { "HB", "Inscrição da Correntista Inválida para o Contrato" },
            { "HC", "Convênio com a Correntista Inexistente/Inválido para o Contrato" },
            { "HD", "Agência/Conta Corrente da Correntista Inexistente/Inválido para o Contrato" },
            { "HE", "Tipo de Serviço Inválido para o Contrato" },
            { "HF", "Conta Corrente da Correntista com Saldo Insuficiente" },
